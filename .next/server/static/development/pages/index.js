...
const {
  query: q,
  Client
} = __webpack_require__(/*! faunadb */ "faunadb");

const Index = () => {
  const [state, setState] = react__WEBPACK_IMPORTED_MODULE_7___default.a.useState({
    info: ""
  });
  const [latest, setLatest] = react__WEBPACK_IMPORTED_MODULE_7___default.a.useState("");
  const [error, setError] = react__WEBPACK_IMPORTED_MODULE_7___default.a.useState("");
  const [success, setSuccess] = react__WEBPACK_IMPORTED_MODULE_7___default.a.useState("");
...
module.exports = __webpack_require__(/*! C:\Users\vicradon\Documents\Codes\Next.js Codes\serverless-demo\pages\index.js */"./pages/index.js");
